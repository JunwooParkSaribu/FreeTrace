...
if 'win' in platform and 'dar' not in platform:
    ...
    subprocess.run(['sudo', 'apt', 'install', '-y', 'clang'])
    ...
    subprocess.run(['sudo', 'apt', 'install', '-y', 'python3-venv'])
    ...
    if python_version == "3.10":
        ...
        subprocess.run(['wget', '--no-check-certificate', 'https://psilo.sorbonne-universite.fr/index.php/s/o8SZrWt4HePY8js/download/models_2_14.zip', '-P' f'{freetrace_path}'])
        ...
        subprocess.run(['rm', '-r', f'{freetrace_path}/models'])
        subprocess.run(['wget', '--no-check-certificate', 'https://psilo.sorbonne-universite.fr/index.php/s/w9PrAQbxsNJrEFc/download/models_2_17.zip', '-P' f'{freetrace_path}'])
