...
from FreeTrace.module.image_module import make_loc_radius_video, remake_visual_trajectories, remake_visual_localizations, make_loc_depth_image, make_loc_radius_video_batch, make_loc_radius_video_batch2, make_diffusion_map
...
if __name__ == '__main__':
    ...
    output_path = 'outputs'
    image_list = ['inputs/sample0.tiff']
    localization_file_list = ['outputs/sample0_loc.csv']
    trajectory_file_list = ['outputs/sample0_traces.csv']
    start_end_frames_for_each_file = [(1, 100)]
    make_loc_radius_video_batch2(output_path, image_list, localization_file_list, trajectory_file_list, frame_cumul=1000, radius=[3, 13],
                                 frame_list=start_end_frames_for_each_file, nb_min_particles=100, max_density=None, color='jet', alpha1=0.65, alpha2=0.35)
    """
